...
module.gui.serversettings = {
	...
	["Moderation"] = "ADMINISZTRÁCIÓ",
	["rules"] = "A szerveredben te hozod meg a szabályokat.",
	["temp"] = "Az összes kitiltás és némítás visszafordíthatatlan.",
	["kick"] = "KIRÚGÁS",
	["ban"] = "KITILTÁS",
	["mute"] = "NÉMÍTÁS",
	...
	["Cooldown"] = "Események és Rigek visszatöltődési ideje. (másodperc)",
...
module.gui.shop = {
	...
	["300tokens"] = "Elég zseton arra, hogy kinyisd az összes varázslatot még 93 maradék zsetonnal.",
	...
	["ARCHITECT"] = "VR-nélküli Architect (R$%d)",

}

module.gui.spellbar = {

	-- ["share"] = "MANA\nMEGOSZTÁS", Might get deleted?
...
module.gui.activatecham = {
	...
	["body"] = "Szeretnéd aktiválni a Chameleon Módot?\nAktív marad addig, ameddig a mászást be nem fejezed."

}

module.gui.caceltimed = {

	["title"] = "VARÁZSLAT ABBAHAGYÁSA",
	["body"] = "Abba akarod hagyni ezt a varázslatot? A zsetonokat nem kapod vissza."
...
module.spells.names = {
	...
	["archspectre"] = "Fantom Vagy Szellem Lépcső",
...
module.spells.descriptions = {
	...
	["autoup"] = "Ez a varázslat létrehoz egy különleges tükrözött szakaszt a lépcső felső részéből. A normális fokok le lesznek eresztve. Csak szellem uniók és Hereticek mehetnek rá arra a szakaszra.",
	...
	["archhacker"] = "Ezt a varázsigét ha egy felületnek a nyilán használod, akkor be fogsz csalni egy lépcsőt ha van ott egy keresztező lépcső. Ha egy normális vagy riges lépcsőn használod, akkor az át fog változni egy mozgólépcsővé, ami az általad választott irányban halad.", --/becsalsz egy keresztező lépcsőt?
	...
	["archdrifter"] = "Ezt a varázsigét ha egy felületen használod, akkor ez át fog változni egy liftté. Ha egy normális vagy riges lépcsőn használod, akkor azt egy véletlenszerű irányba el fogja sodorítani.",
...
module.gui.ranks = {
	...
	["none_2"] = "Egy varázslatod se lesz, ameddig nem választasz egy osztályt!",
...
module.gui.reshuffle = {
	...
	["body"] = "El akarod kerülni a lépcsők ütközését? Ha nem, akkor az útban álló lépcsők el lesznek pusztítva.",
...
module.gui.settings = {
	...
	["ANIM"] = "ANIMÁCIÓ\nBEÁLLÍTÁSAI",	
	["MISC"] = "VEGYES\nBEÁLLÍTÁSOK",
	["INTER"] = "GRAFIKUS ABLAKOK\nBEÁLLÍTÁSA",	
	["INTER2"] = "MÉGTÖBB GRAFIKUS\nABLAK BEÁLLÍTÁS",	

	["list"] = "Animált játékoslista megjelenítése",
	["morph"] = "Átváltozási animáció mutatása Deceiverként vagy Usurperként",
	["billboard"] = "Saját osztályod rangjának megjelenítése",
	["rank"] = "Összefoglaló Rangod Mutatása az osztályod rangja felett",
	["switchback"] = "Automatikus visszaváltás átlagos varázslatokra egy különleges varázslat végrehajtása után",
	["safecancel"] = "Megerősítési ablak mutatása amikor egy időzített varázslatot abbahagysz",
	["multi"] = "Multi Zseton ablak mutatása mászások után",
	["kchoices"] = "Irányválasztási ablak mutatása Keeperként (nem működik konzolon)",
	["hchoices"] = "Irányválasztási ablak mutatása Hackerként (nem működik konzolon)",
	["achoices"] = "Irányválasztási ablak mutatása Archonként (nem működik konzolon)",
	["rchoices"] = "Irányválasztási ablak mutatása Reaverként (nem működik konzolon)",
	["schoices"] = "Irányválasztási ablak mutatása Splicerként (nem működik konzolon)",
	["gchoices"] = "Irányválasztási ablak mutatása Gremlinként (nem működik konzolon)",
	["stats"] = "Több statisztika mutatása amikor varázsolsz Rig & Esemény varázslatokat",
...
module.gui.gameover.maxrank ={
	...
	["DABSFORLIF"] = "Kinek kell varázslat?",
	...
	["ALIEN"] = "Egyek 𐳔𐳙𐳪𐳎𐳀𐳮.knuygav 𐲉𐳎𐳉𐳔", --Translation: We are one but in an alien way.
...
module.gui.gameover.credits = {
	...
	"Adat tároló modult (DataStore2-t) készítette: Kampfkarren",
	"Eredeti ranglista kódját írta: ThatTimothy",
	"VIZSGÁLÓK:",
	"FORDÍTÁSOK:",
	"KÜLÖN KÖSZÖNET:",
	"ZENE (APM catalog):",
...
module.static = {
	...
	["house_1"] = "ARCHITECT HÁZA", --?
	["house_2"] = "JELMONDATUNK:\nÉPÍTS\nVÁLTOZTASS(?)\nÉS\n", --??????
	["house_3"] = "ELŐNYÖK:\nTudsz repülni(??) (végtelen mana??)\nMegsegíthetsz, vagy megszivathatsz másokat\nHÁTRÁNYOK:\nRobuxba kerül\nNem nyerhetsz ezzel az osztállyal",
	["house_4"] = "„”\nalapítónk idézete",
...
module.guide = {
	...
	["both"] = {
		...
		["archwicked"] = "Wicked Fala Kapocs nélkül (ha egy nyílon használod) vagy Lépcső Elpusztítása (ha egy lépcsőn használod)",
...
module.serverfeedback = {
	...
	["regwait"] = "Nem varázsolhatsz rigeket vagy eseményeket, miközben a Lépcsőház újraépül.",
	["cooldownwait"] = "Nem varázsolhatsz rigeket vagy eseményeket, kérlek várj %d másodpercet.",
	...
	["nopass"] = "Ezt a varázslatot csak a torony külső felületein lehet végrehajtani.",
	["pass"] = "Már van itt egy kitérés.",
	["link"] = "Már van itt egy kapocs.",
	["noblink"] = "Csak útban álló lépcsőkön lehet átvillanni.",
	["noblink2"] = "Nem tudod felvonóhidakon vagy lehajlított lépcsőkön végrehajtani ezt a varázslatot.", --Csak olyan lépcsőkön tudod végrehajtani ezt a varázslatot, amelyeknek a teteje hozzá ér az útban álló lépcsőhöz.
	...
	["linklimit"] = "Csak a feletted lévő lépcsőre ható varázslatokat lehet kapcsokon végrehajtani.",
	...
	["lockedsplit"] = "Még nem tudod létrehozni a kapukat, a másik lépcső le van zárva.",
	...
	["tryarchitect"] = "VR-nélküli Architect feloldva 10 percig! Ne hagyd el a szervert.",
	["newarchitectpass"] = "Most már lehetsz ARCHITECT!",
	["endarchitect"] = "VR-nélküli Architect demó 1 perc múlva véget ér!",
...
module.localfeedback = {
	...
	["nomuggle"] = "Tényleg azt hitted, hogy Mugglenek van titkos különleges varázslatja?",
	["nonone"] = "Tényleg azt hitted, hogy Nonenak van titkos különleges varázslatja?",
...
module.switchon = {
	...
	["JOKER"] = "Nem fogsz láthatatlan lépcsőket felfedni.",
	["WICKED"] = "Nem fogsz aktiválni Wicked Rigeket.",
	["KEEPER"] = "Nem fogsz aktiválni Keeper Rigeket.",
	["SPECTRE"] = "Nem fogsz aktiválni Spectre Rigeket.",
	["HACKER"] = "Mozgólépcső és rig immunitás bekapcsolva.",
	["ARCHON"] = "Csak felfelé vezető kapuk hatnak rád.",
	["DRIFTER"] = "Nem fogsz aktiválni Drifter Rigeket.",
	["SPLICER"] = "Nem fogsz aktiválni Splicer Rigeket.",
	["REAVER"] = "Nem fogsz aktiválni Reaver Rigeket.",
...
module.switchoff = {
	...
	["JOKER"] = "Fel fogsz fedni láthatatlan lépcsőket.",
	["WICKED"] = "Aktiválni fogsz Wicked Rigeket.",
	["KEEPER"] = "Aktiválni fogsz Keeper Rigeket.",
	["SPECTRE"] = "Aktiválni fogsz Spectre Rigeket.",
	["HACKER"] = "Mozgólépcső és rig immunitás kikapcsolva.",
	["ARCHON"] = "A lefelé vezető kapukon kívül az összes kapu hat rád.",
	["DRIFTER"] = "Aktiválni fogsz Drifter Rigeket.",
	["SPLICER"] = "Aktiválni fogsz Splicer Rigeket.",
	["REAVER"] = "Aktiválni fogsz Reaver Rigeket.",
...
module.spells.extras = {
	...
	["Title3"] = "Megosztott különleges varázslatok",
...
module.gui.hints = {
	...
	["ocancel"] = "Előbb szüntesd meg a másik varázslatot", 
}
